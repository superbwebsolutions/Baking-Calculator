...
|--------|--------------|----------------|
| **Search Volume** | Volume score (1-100) | Higher volume = more potential impressions |
| **Difficulty** | Competition score (1-100) | Lower difficulty = easier to rank. |
| **Reviews (100 Rule)** | `topAppsAvgReviews` | **Repository Standard:** Any keyword where top apps average **> 100 reviews** is considered **HARD**, regardless of the Difficulty score. Always target keywords with < 100 avg reviews for new apps. |
